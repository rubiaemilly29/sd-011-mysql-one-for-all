...
INSERT INTO planos (planos, valor_plano) VALUES
('gratuito', 0),
('familiar', 7.99),
('universitário', 5.99);

INSERT INTO usuarios(plano_id, usuarios, idade) VALUES
(1, 'Thati', 23),
(2, 'Cintia',35),
(3, 'Bill',20),
(1, 'Roger', 45);

INSERT INTO artistas(artistas) VALUES
('Walter Phoenix'),
('Peter Strong'),
('Lance Day'),
('Freedie Shannon');
...
INSERT INTO cancoes(album_id, cancoes) VALUES
(1, 'Soul For Us'),
...
(3,2),
(3,1),
(4,4);DROP DATABASE IF EXISTS SpotifyClone;
CREATE DATABASE SpotifyClone;
USE SpotifyClone;
CREATE TABLE planos(
plano_id INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
