...
INSERT INTO `plan` (`plan_id`, `plan_name`, `plan_price`) VALUES
(1, 'gratuito', '0.00'),
(2, 'familiar', '7.99'),
...
INSERT INTO `users` (`user_id`, `user_name`, `user_age`, `plan_id`) VALUES
(1, 'Thati', 23, 1),
(2, 'Cintia', 35, 2),
(3, 'Bill', 20, 3),
(4, 'Roger', 45, 1);
...
INSERT INTO `followup` (`user_id`, `artist_id`) VALUES
(1, 1),
(1, 3),
(1, 4),
(2, 1),
