...
VALUES
  (1, 'Soul For Us'), -- 1
  (1, 'Reflections Of Magic'), -- 2
  (1, 'Dance With Her Own'), -- 3
  (2, 'Troubles Of My Inner Fire'), -- 4
  (2, 'Time Fireworks'), -- 5
  (3, 'Magic Circus'), -- 6
  (3, 'Honey, So Do I'), -- 7
  (3, 'Sweetie, Let''s Go Wild'), -- 8
  (3, 'She Knows'), -- 9
  (4, 'Fantasy For Me'), -- 10
  (4, 'Celebration Of More'), -- 11
  (4, 'Rock His Everything'), -- 12
  (4, 'Home Forever'), -- 13
  (4, 'Diamond Power'), -- 14
  (4, 'Honey, Let''s Be Silly'),-- 15
  (5, 'Thang Of Thunder'), -- 16
  (5, 'Words Of Her Life'), -- 17
  (5, 'Without My Streets'); -- 18
